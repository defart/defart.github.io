        ...
        this.window.top.onmessage = (e) => {
            ...
            try {
                ...
                if (msg.action === _iframe_sock_iframeSocket__WEBPACK_IMPORTED_MODULE_0__["ISOCK_ACTION_CONNECT"] && e.ports.length && e.ports[0]) {
                    ...
                    this.sock.send(Object.assign(Object.assign({}, msg), { action: _iframe_sock_iframeSocket__WEBPACK_IMPORTED_MODULE_0__["ISOCK_ACTION_READY"], payload: _iframe_sock_iframeSocket__WEBPACK_IMPORTED_MODULE_0__["ISOCK_ACTION_READY"], status: 200 }));
                }
            }
            catch (e) {
...
class Client {
    ...
    init() {
        ...
        return new Promise((resolve, reject) => {
            ...
            window.top.postMessage(JSON.stringify({ action: _iframe_sock_iframeSocket__WEBPACK_IMPORTED_MODULE_1__["ISOCK_ACTION_CONNECT"] }), this.portalUrl, [this.channel.port2]);
